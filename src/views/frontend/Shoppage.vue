          ...
          <div class="container">
            <div class="border">
              <button
                ...
                data-target="#collapseProductClass"
                aria-expanded="false"
              ...
              <div class="collapse" id="collapseProductClass">
                <div class="card card-body border-0">
                  <ul class="all">
                    <li>
                      <a href="#" @click.prevent="filter ='顯示所有商品'">顯示所有商品</a>
                    </li>
                  </ul>
                  <ul>
                    <li>
                      <a href="#" class="d-flex" @click.prevent="filter ='貓食'">
                        <span>貓食</span>
                        <span class="ml-auto">3</span>
                      </a>
                    </li>
                    <li>
                      <a href="#" class="d-flex" @click.prevent="filter ='貓抓板'">
                        <span>貓抓板</span>
                        <span class="ml-auto">3</span>
                      </a>
                    </li>
                    <li>
                      <a href="#" class="d-flex" @click.prevent="filter ='寵物周邊'">
                        <span>寵物周邊</span>
                        <span class="ml-auto">3</span>
                      </a>
                    </li>
