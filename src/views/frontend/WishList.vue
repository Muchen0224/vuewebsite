            ...
            <div class="wish" v-for="item in wishList" :key="item.id">
              <div class="container">
                ...
                <div class="row flex-nowrap">
                  <div
                    class="col-6 pl-0 input-wrap d-flex align-items-center justify-content-start"
                  >
...
export default {
  ...
  methods: {
    ...
    removeWishListItem (id) {
      const vm = this
      const deleteTarget = vm.wishListId.findIndex(item => item === id)
