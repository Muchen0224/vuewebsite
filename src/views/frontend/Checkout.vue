                ...
                <div class="border p-5">
                  ...
                  <div class="create-order">
                    <div class="container">
                      <div class="row">
                        <button
                          class="btn btn-primary btn-lg col-12 justify-content-center"
...
#content .purchase-info .buyer-info .title,
#content .purchase-info .order-info .title {
  font-size: 28px;
  font-weight: 800;
}
